...
// Indicative public (non-subscription) prices per kWh for major NL operators
const OPERATOR_PRICES: Record<string, { price: number; note: string }> = {
  'fastned':       { price: 0.79, note: 'Publiek tarief, €0.69 met abonnement' },
  'allego':        { price: 0.45, note: 'Publiek AC/DC tarief (varieert per locatie)' },
  'shell':         { price: 0.59, note: 'Shell Recharge publiek tarief' },
  'shell recharge':{ price: 0.59, note: 'Shell Recharge publiek tarief' },
  'vattenfall':    { price: 0.36, note: 'Publiek tarief' },
  'nuon':          { price: 0.36, note: 'Vattenfall/NUON publiek tarief' },
  'evbox':         { price: 0.40, note: 'Indicatief; varieert per locatie' },
  'eneco':         { price: 0.38, note: 'Eneco publiek tarief' },
  'greenlots':     { price: 0.40, note: 'Indicatief tarief' },
  'bp pulse':      { price: 0.55, note: 'BP Pulse publiek tarief' },
  'totalenergies': { price: 0.48, note: 'TotalEnergies publiek tarief' },
  'ionity':        { price: 0.79, note: 'Publiek tarief, €0.35 met abonnement' },
  'lidl':          { price: 0.29, note: 'Gratis of laag tarief bij Lidl' },
